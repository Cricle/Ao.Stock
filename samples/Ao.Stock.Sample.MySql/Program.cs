...
var mysql = $"server=127.0.0.1;port=3306;userid=root;password=;database=ea359198cfdf4b67ab200acfcd3ad865_runtime;characterset=utf8mb4;";
...
record struct Student1([property: Key] long Id, [property: SqlIndex][property: MaxLength(20)] string Name);
